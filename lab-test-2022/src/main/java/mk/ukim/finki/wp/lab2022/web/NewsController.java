...
public class NewsController {
     ...
     */
    @GetMapping({"/","/news"})
    public String showNews( @RequestParam(required = false) Double price,@RequestParam(required = false) NewsType type, Model model) {
        List<News> news;
    ...
    public String showAdd(Model model) {
        List<NewsCategory> newsCategories = this.newsCategoryService.listAll();
        List<NewsType> type = new ArrayList<NewsType>(Arrays.asList(NewsType.values()));
    ...
    public String showEdit(@PathVariable Long id, Model model) {
        News news = this.service.findById(id);
        List<NewsCategory> newsCategories = this.newsCategoryService.listAll();
        List<NewsType> type = new ArrayList<NewsType>(Arrays.asList(NewsType.values()));
        model.addAttribute("type",type);
        model.addAttribute("newsCategories", newsCategories);
